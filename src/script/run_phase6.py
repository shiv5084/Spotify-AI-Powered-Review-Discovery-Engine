...
def main():
    ...
    # 2. Verify all 7 metric component files exist
    components_dir = os.path.join(frontend_path, "src", "components", "dashboard")
    required_components = [
        "BarriersSection.tsx",
        "FrustrationsSection.tsx",
        "ListeningGoalsSection.tsx",
        "RepeatDriversSection.tsx",
        "SegmentsSection.tsx",
    ...
    try:
        # On Windows, shell=True is needed to resolve npm command properly
