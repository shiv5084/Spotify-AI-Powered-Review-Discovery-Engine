...
def main():
    ...
    try:
        pulse_note_text = generator.generate_and_save_report(padded_results, pulse_note_file)
    ...
    try:
        ...
        dashboard_data = exporter.export_dashboard_json(padded_results, opps, pulse_note_text, dashboard_json_file)
