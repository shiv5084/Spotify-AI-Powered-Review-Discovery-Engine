...
| Metric | Target | 
|---|---|
|Google Play Store scrape (1000 reviews) | < 120s |
...
| Combined Raw reviews |≥1100 reviews|
| Cleaned & Processed reviews |≥800 reviews|
...
- **Ingestion Target Counts (Per URL/Source)**:
  ...
  - **Google Play Store**: $\ge 1000$ raw reviews scraped.
