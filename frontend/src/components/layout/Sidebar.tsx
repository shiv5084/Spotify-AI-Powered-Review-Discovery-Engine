      ...
      {isDashboard && (
        <div className={styles.section}>
          ...
          <div className={styles.jumpLinks}>
            <div onClick={() => handleScrollToSection('barriers')} className={styles.jumpLink}>
            ...
            <div onClick={() => handleScrollToSection('goals')} className={styles.jumpLink}>
              3. Listening Goals
            </div>
            <div onClick={() => handleScrollToSection('drivers')} className={styles.jumpLink}>
              4. Repeat Drivers
            </div>
